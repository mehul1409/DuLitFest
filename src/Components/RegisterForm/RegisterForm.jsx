    ...
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="ui form">
          ...
          <p className=".RegistrationForm_p">{formErrors.username}</p>
          <div className="field">
            <label>Email</label>
            <input
              type="text"
          ...
          <p className=".RegistrationForm_p">{formErrors.email}</p>
          <div className="field">
          ...
          <p className=".RegistrationForm_p">{formErrors.password}</p>
